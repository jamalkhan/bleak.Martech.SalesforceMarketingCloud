...
{
    public partial class OpenEventSoapApi
        : BaseDataSetSoapApi<OpenEvent, OpenEventPoco>
    {
        public DateTime StartDate { get; set; }  = DateTime.MinValue;
        public DateTime EndDate { get; set; } = DateTime.MinValue;

        public OpenEventSoapApi(IAuthRepository authRepository, IFileWriter fileWriter, DateTime startDate, DateTime endDate)
            : base(
        ...
        public override OpenEventPoco ConvertToPoco(OpenEvent wsdlObject)
        {
            OpenEventPoco poco = new OpenEventPoco();
        ...
        public override string BuildRequest()
        {
            ...
            sb.AppendLine($"                <ObjectType>OpenEvent</ObjectType>");
